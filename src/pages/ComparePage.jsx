...
function ComparePage() {
  const { loading, result, setResult, history, clearHistory, runCompare } = useQuantity();
  ...
  const handleRun = async () => {
    ...
    try {
      await runCompare({ v1: parseFloat(v1), u1, v2: parseFloat(v2), u2, type });
    ...
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <div className="op-wrap">
        <div className="app-card">
          <div className="app-card-header">⚖️ Quantity Comparison</div>
